...
from apps.altogether.src.training.data import get_data
from apps.altogether.src.training import train
...
def main(args):
    ...
    if hasattr(args, "engine"):
        ...
        import importlib
        for model_code in os.listdir(f"apps/altogether/src/training"):
            if model_code.startswith("train"):
                module = importlib.import_module("apps.altogether.src.training." + model_code[:-len(".py")])
